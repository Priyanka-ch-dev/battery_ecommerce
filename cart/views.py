    ...
    def checkout(self, request, pk=None):
        ...
        if delivery_date and delivery_time:
            ...
            if not slot.is_active or slot.current_bookings >= slot.max_bookings:
                ...
                return Response({
                    "error": "This delivery/installation slot is already booked for your area. Please select another available time slot or contact Customer Support.+91 9483808080 / 9731140727",
